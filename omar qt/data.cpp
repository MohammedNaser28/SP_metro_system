...
//void ReadFromFile() {
//   
//    QString path = QCoreApplication::applicationDirPath() + "/data of users.txt";
//    ifstream inputfromfile(path.toStdString());
//
...
//    inputfromfile.close();
//
//    // Similarly adjust this block too:
//    QString complaintsPath = QCoreApplication::applicationDirPath() + "/complains.txt";
//    ifstream inputcomplaint(complaintsPath.toStdString());
//
//    if (!inputcomplaint.is_open()) {
//        cerr << "Error: Cannot open 'complains.txt' at " << complaintsPath.toStdString() << endl;
//        return;
//    }
//
