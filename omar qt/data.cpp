...
void load_subsc_data() {
    QString filePath = getDataFilePath("subsc data.txt");
    QFile file(filePath);

    if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        qDebug() << "No subscription data found at" << filePath;
        return;
    }
    ...
    file.close();
    qDebug() << "Loaded" << num_of_subsc << "subscription plans";
}
...
void save_subsc_data() {
    ...
    if (!file.open(QIODevice::WriteOnly | QIODevice::Text)) {
        qDebug() << "Error opening file for writing at" << filePath;
        return;
    }
    ...
    file.close();
    qDebug() << "Saved" << num_of_subsc << "subscription plans";
}

// User subscription functions
void load_user_subsc() {
    QString filePath = getDataFilePath("subsc.txt");
    QFile file(filePath);

    if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        qDebug() << "No user subscription data found at" << filePath;
        return;
    }
    ...
    file.close();
    qDebug() << "Loaded subscriptions for" << number_of_users_in_array << "users";
}
...
void save_user_subsc() {
    ...
    file.close();
    qDebug() << "Saved subscriptions for" << number_of_users_in_array << "users";
}
